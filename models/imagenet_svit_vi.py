...
class Model(base.Model):
    """A Simple ViT."""
    is_vi_model = True
    dataset_size_train = 1281167  # size of imagenet train
    dataset_size_test = 50000  # size of imagenet test
    
    def __init__(self, plan, initializer, outputs=None):
        super(Model, self).__init__()
        outputs = outputs or 1000

        embed_dim = {"tiny": 256, "small": 1024, "base": 2048}[plan]
        self.vit = SimpleViT(dim=embed_dim, image_size=224, patch_size=32, num_classes=outputs, depth=6, heads=16, dim_head=64, mlp_dim=2048)
    ...
    def is_valid_model_name(model_name):
        return (model_name.startswith('imagenet_visvit_') and model_name.split("_")[2] in ["tiny", "small", "base"])
    ...
    def default_hparams():
        model_hparams = hparams.ModelHparams(
            model_name='imagenet_visvit_small',
        ...
        pruning_hparams = sparse_vi.PruningHparams(
            ...
            pruning_layers_to_ignore="vit.linear_head.weight,vit.linear_head.bias",
        )
