...
from models import cifar_resnet, cifar_vgg, mnist_lenet, imagenet_resnet, cifar_deit, cifar_resnet_bnn
from models import bn_initializers, initializers
from platforms.platform import get_platform

registered_models = [mnist_lenet.Model, cifar_resnet.Model, cifar_vgg.Model, imagenet_resnet.Model, cifar_deit.Model, cifar_resnet_bnn.Model]
