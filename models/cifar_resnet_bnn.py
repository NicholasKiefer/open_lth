...
from models.layers.bnns import BayesianConv2d, BayesianLinear, BayesianBatchNorm2d
from models.layers.utils import kl_div
...
class Model(base.Model):
    ...
    def __init__(self, plan, initializer, outputs=None):
        ...
        self.fc = BayesianLinear(plan[-1][0], outputs)
        # self.criterion = nn.CrossEntropyLoss()
        # kl_loss = 1 / len(loader) * kl_div(model) * 4e-3
        self.criterion = lambda x,y: F.cross_entropy(x, y) + 0.01 * kl_div(self)
